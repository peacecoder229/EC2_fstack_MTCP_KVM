...
sleep 3
		 ...
		 for act in "2p4_c6_off" "2p4_c6_on" "2p4_c6_off_r2" "2p4_c6_on_r2" "2p4_c6_off_r3" "2p4_c6_on_r3" "turbo_c6_off_r3"  "turbo_c6_on_r3" "turbo_c6_off_r2"  "turbo_c6_on_r2" "turbo_c6_off"  "turbo_c6_on" 
		   do
			...
			./run_client_and_server_memtier_r1p1.py --ratio "1:4"  --scores=1-4 --mark ip6_${act} --host 192.168.6.99 --ccores=20-23 --port=all  --keymax=1000001 --con_num=$con -n 50000 -p $p -d $d &
			./run_client_and_server_memtier_r1p1.py --ratio "1:4"  --scores=5-8 --mark ip7_${act} --host 192.168.7.99 --ccores=16-19 --port=all  --keymax=1000001 --con_num=$con -n 50000 -p $p -d $d &
			./run_client_and_server_memtier_r1p1.py --ratio "1:4"  --scores=9-12 --mark ip8_${act} --host 192.168.8.99 --ccores=4-7 --port=all  --keymax=1000001 --con_num=$con -n 50000 -p $p -d $d &
			./run_client_and_server_memtier_r1p1_emon.py --ratio "1:4"  --scores=13-16 --mark ip5_${act} --host 192.168.5.99 --ccores=0-3 --port=all  --keymax=1000001 --con_num=$con -n 50000 -p $p -d $d
