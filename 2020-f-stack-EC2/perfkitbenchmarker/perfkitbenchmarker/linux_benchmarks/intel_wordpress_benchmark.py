...
"""Runs Siege against PHP/WordPress.
...
flags.DEFINE_integer('intel_wordpress_client_threads', None,
...
DATA_FILES = ['intel_wordpress_benchmark/config.yml']
...
def Run(benchmark_spec):
  ...
  return intel_php_utils.Run(benchmark_spec,
                             'wordpress',
                             'php',
                             FLAGS.intel_wordpress_execution_count,
                             FLAGS.intel_wordpress_server_threads,
                             FLAGS.intel_wordpress_client_threads,
                             mt=False)
...
def Cleanup(benchmark_spec):
  ...
  Args:
    benchmark_spec: The benchmark specification. Contains all data that is
        required to run the benchmark.
  """
  vm_util.RunThreaded(lambda v: v.Uninstall('intel_webtier_provisioning'), benchmark_spec.vm_groups['target'])
