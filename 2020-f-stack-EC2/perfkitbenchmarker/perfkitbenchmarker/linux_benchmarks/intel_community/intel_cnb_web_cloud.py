...
INSTALLED_PACKAGES = {}
OS_INFO = {}
BENCHMARK_NAME = "intel_cnb_web_cloud"
BENCHMARK_DATA_DIR = "intel_cnb_web_cloud_benchmark"
...
intel_cnb_web_cloud:
  description: Runs CNB web benchmark.
  vm_groups:
    vm_group1:
      os_type: ubuntu1804
...
def Prepare(benchmark_spec):
  ...
  intel_k8s.InstallK8sCSP(target, vms[1:], False)
...
def Run(benchmark_spec):
  ...
  vm.RemoteCommand(("cd {0} && cp {1} {2}").format(BENCHMARK_DIR, PARSE_SCRIPT, remote_run_path))
