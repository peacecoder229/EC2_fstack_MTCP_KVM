...
do
  ...
  case "$exp_type" in
    nginx)
      case_no="case_2" #case_1: primary active, secondary idle; case_2: both primary and secondary active
    ...
    memcached)
      ...
      ./run_ec2_exp_r_mc_mb.sh $processor_type $instance_type $no_of_cores $exp_type $instance_no &
      ./run_ec2_exp_r_mc_mb.sh $processor_type $instance_type $no_of_cores $exp_type $instance_no &
      ./run_ec2_exp_r_mc_mb.sh $processor_type $instance_type $no_of_cores $exp_type $instance_no &
      ./run_ec2_exp_r_mc_mb.sh $processor_type $instance_type $no_of_cores $exp_type $instance_no &
    ;;
