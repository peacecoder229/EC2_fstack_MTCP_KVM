...
sleep 3
			...
			./run_client_and_server_memtier_r1p1.py --ratio "1:4"  --scores=8-12 --mark ip6_c6en_N500k --host 192.168.6.99 --ccores=16-23 --port=all  --keymax=1000001 --con_num=$con -n 50000 -p $p -d $d &
			./run_client_and_server_memtier_r1p1.py --ratio "1:4"  --scores=13-17 --mark ip7_c6dis --host 192.168.7.99 --ccores=8-15 --port=all  --keymax=1000001 --con_num=$con -n 50000 -p $p -d $d &
			./run_client_and_server_memtier_r1p1.py --ratio "1:4"  --scores=18-22 --mark ip8_c6dis --host 192.168.8.99 --ccores=24-31 --port=all  --keymax=1000001 --con_num=$con -n 50000 -p $p -d $d &
			./run_client_and_server_memtier_r1p1_emon.py --ratio "1:4"  --scores=23-27 --mark ip5_c6dis --host 192.168.5.99 --ccores=0-7 --port=all  --keymax=1000001 --con_num=$con -n 50000 -p $p -d $d
