...
#echo "./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:0 inst${serv}${core} redis ${ms}-${me} /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1} ${port} "4" launchserver & "
if [ "$hypt" == "on" ]
then

	export hypt="on"
	echo "./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:0 inst${serv}${core} redis ${ms}-${me} /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1},${stc2}-${edc2} ${port} "1" launchserver &"
	./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:0 inst${serv}${core} redis ${ms}-${me} /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1},${stc2}-${edc2} ${port} "1" launchserver &

else
	 export hypt="off"

	echo "./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:0 inst${serv}${core} redis ${ms}-${me} /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1} ${port} "1" launchserver &"
	./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:0 inst${serv}${core} redis ${ms}-${me} /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1} ${port} "1" launchserver &
fi
#echo "./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:0 inst${serv}${core} redis ${ms}-${me} /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1},${stc2}-${edc2} ${port} "4" launchserver &"
#./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:0 inst${serv}${core} redis ${ms}-${me} /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1},${stc2}-${edc2} ${port} "4" launchserver &
wrpids[$serv]=$!
serv=$(( serv+1 ))
...
then
	...
	echo "./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:4 inst${serv}${core} redis ${cstc1}-${cedc1},${cstc2}-${cedc2}  /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1},${stc2}-${edc2} ${port} ${connections} &"
	./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:4 inst${serv}${core} redis ${cstc1}-${cedc1},${cstc2}-${cedc2}  /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1},${stc2}-${edc2} ${port} ${connections} &

else

	echo "./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:4 inst${serv}${core} redis ${cstc1}-${cedc1}  /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1} ${port} ${connections} &"
	./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:4 inst${serv}${core} redis ${cstc1}-${cedc1}  /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1} ${port} ${connections} &
#	./amd_memcached_core_scale.sh 1048576 127.0.0.1 1:4 inst${serv}${core} redis 24-47  /root/redis_memcachd_memtier_benchmark/core_scale ${stc1}-${edc1} ${port} ${connections} &
...
reshp=$(cat testsum | grep -v "filename" | awk -F, '{sum += $4; sum2 += $6} END {print sum " " sum2}')
...
mkdir -p $res_dir
if [ ! -f $res_dir/memc_run2_res.txt ]
then
	touch $res_dir/memc_run2_res.txt
fi

echo "${total} ${ins} ${connections} ${reshp} ${hpthrput} ${hypt}" >> $res_dir/memc_run_res.txt
