...
sleep 3
		...
		for act in "ddio_tx2_rx2"
			...
			sleep 1
			./run_client_and_server_memtier_r1p1.py --ratio "1:4"  --scores=2-3 --mark ip6_${act}_d${d} --host 192.168.232.100 --ccores=1-2 --port=all  --keymax=1000001 --con_num=$con -n 500000 -p $p -d $d --sport 9001 &
			./run_client_and_server_memtier_r1p1.py --ratio "1:4"  --scores=2-3 --mark ip6_${act}_d${d} --host 192.168.232.100 --ccores=3-4 --port=all  --keymax=1000001 --con_num=$con -n 500000 -p $p -d $d --sport 9001 &
			./run_client_and_server_memtier_r1p1_emon.py --ratio "1:4"  --scores=2-3 --mark ip6_${act}_d${d} --host 192.168.232.100 --ccores=5-6 --port=all  --keymax=1000001 --con_num=$con -n 500000 -p $p -d $d --sport 9001
